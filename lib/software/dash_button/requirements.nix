...
#
# COMMAND:
#   pypi2nix -V 3 -I /home/arnold/programme/nixconfig/ -r requirements.txt
#
...
let
  ...
  generated = self: {
    ...
    "scapy" = python.mkDerivation {
      name = "scapy-2.4.0rc4";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/59/55/392c68f2a8bad3a51d24de415645c042621937726b06d431ea40bf5922dd/scapy-2.4.0rc4.tar.gz"; sha256 = "2f967bac849eb19e8920ab8ebaef90fa093b8a3a3d542e23cd0f04c3acde2851"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
